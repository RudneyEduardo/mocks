...
function setRequestDocId(access_token, DocId) {
    return {
        "url": "https://api-terosopenbanking.sensedia.com/poc/basic-retail/Inquiries/" + DocId + "/asynchronous",
        "method": "GET",
        "timeout": 0,
        "headers": {
...
function setPathConfirmSettings(access_token, DocId) {
    var settings = {
        "url": "https://api-terosopenbanking.sensedia.com/poc/basic-retail/Inquiries/" + DocId + "/asynchronous/" + DocIdProtocol,
        "method": "PATCH",
        "timeout": 0,
        "headers": {
            "Content-Type": "application/json",
...
function setCreditProposalSettings(access_token, tax, amount, amountTax, comment) {
    return {
        "url": "https://api-terosopenbanking.sensedia.com/poc/basic-retail/proposals/9394C8BD-248A-4361-B324-D55F7C2E7461/analysis",
        "method": "POST",
        "timeout": 0,
        "headers": {
            "Content-Type": "application/json",
...
function setPatchProposalSettings(access_token, tax, amount, amountTax, comment, proposal_protocol) {
    return {
        "url": "https://api-terosopenbanking.sensedia.com/poc/basic-retail/proposals/9394C8BD-248A-4361-B324-D55F7C2E7461/analysis/" + proposal_protocol,
        "method": "POST",
        "timeout": 0,
        "headers": {
            "Content-Type": "application/json",
...
return {
    "url": "https://api-terosopenbanking.sensedia.com/poc/basic-retail/proposals/9394C8BD-248A-4361-B324-D55F7C2E7461/analysis/"+ProposalProtocol+"/status",
    "method": "GET",
    "timeout": 0,
    "headers": {
      "Content-Type": "application/json",
            ...
            $.ajax(setCallbackSettings(access_token, $("#fname").val())).done(function (response) {
                ...
                for (var i = 2; i < 6; i++) {
                    var radioBtn = $("<label> R$" + (ValorPedido + ((ValorPedido / 100 * response.tax) * i)) +
                        " en " + i + "X con tasa de interés de " + response.tax + "% </label><input type='radio' value='"
                        + (ValorPedido + ((ValorPedido / 100 * response.tax) * i)) +
                        " en " + i + "X con tasa de interés de " + response.tax +
                        "' name='rbtnCount' /><br>");
...
$("#btnConfirmCredit").on("click", function () {
    ...
    $("#screen_credit_confirm p").text("Mundo Retail está solicitando la " +
        "confirmación de la operación de crédito con valor de: " + $('input[name=rbtnCount]:checked').val() + "%")
